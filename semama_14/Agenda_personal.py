...
etiqueta_fecha = tk.Label(frame_entrada, text="Fecha:", bg="#FFDAB9", fg="black", font=("Arial", 10, "bold"))
...
etiqueta_descripcion = tk.Label(frame_entrada, text="Descripción:", bg="#FFDAB9", fg="black", font=("Arial", 10, "bold"))
